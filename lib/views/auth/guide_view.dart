...
class GuideView extends StatelessWidget {
  GuideView({Key? key, this.isFirst}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return ViewModelBuilder<GuideViewModel>.reactive(
      ...
      onModelReady: (model) => model.initialize(context, isFirst),
    );
  }
    ...
    return WillPopScope(
        child: Scaffold(
          ...
          body: Stack(
            children: <Widget>[
              Container(
                  padding: model.mIsFirst
                      ? const EdgeInsets.fromLTRB(0, 10, 0, 70)
