...
import 'package:zimbo/view_models/other/subscription/edit_subscription_card_view_model.dart';

class EditSubscriptionCardView extends StatelessWidget {
  EditSubscriptionCardView({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return ViewModelBuilder<EditSubscriptionCardViewModel>.reactive(
      viewModelBuilder: () => EditSubscriptionCardViewModel(),
  ...
  buildWidget(
      BuildContext context, EditSubscriptionCardViewModel model, Widget? child) {
